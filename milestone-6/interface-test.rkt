...
(module+ test
  ...
  (check-import-list "passes/propagate-copies.rkt"             '(propagate-copies))
  (check-import-list "passes/bury-dead.rkt"                    '(bury-dead))
  ...
  (check-import-list "passes/assign-call-undead-variables.rkt" '(assign-call-undead-variables))
  (check-import-list "passes/allocate-frames.rkt"              '(allocate-frames))
  (check-import-list "passes/assign-registers.rkt"             '(assign-registers))
  (check-import-list "passes/assign-frame-variables.rkt"       '(assign-frame-variables))
  ...
  (check-import-list "passes/trace-schedule.rkt"               '(trace-schedule))
  (check-import-list "passes/flatten-program.rkt"              '(flatten-program))
  (check-import-list "passes/inline-jumps.rkt"                 '(inline-jumps))
